...
export const metadata = buildPageMetadata({
  title: "Terms",
  description:
    "Terms for using the McGraw Made Studio website, custom project inquiries, and ready-made item information.",
  path: "/terms",
});

const page = policyPages.find((item) => item.slug === "terms");
